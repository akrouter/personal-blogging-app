...
export default function ElonMusk () {
    return (
        <div className="w-full h-full bg-gray-100 pt-[30px] pl-[60px]">
            ...
            <div className="mb-[25px]">
                <h1 className="font-bold text-m">All From Elon Musk</h1>
            </div>
            <div className="flex">
            <div className="w-[60%] bg-white p-[20px] mt-[20px] mb-[20px] rounded-md shadow-md mr-[200px]">
                <div className="flex">
                    ...
                    <div>
                        <div>
                            <h1 className="font-bold text-xl">Introducing Twiter</h1>
                        </div>
                        <div>
            ...
            <div className="mt-[30px]">
                <div className="flex flex-col items-end">
                    <div className="mb-[10px]"> 
                        <h1 className="font-bold text-2xl text-[#9747ff]">Elon Musk</h1>
                    </div>
            ...
            <div className="w-[60%] bg-white p-[20px] mt-[20px] mb-[20px] rounded-md shadow-md">
                <div className="flex">
                    ...
                    <div>
                        <div>
                            <h1 className="font-bold text-xl">Introducing Twiter-X-Logo</h1>
                        </div>
                        <div>
                            <span className="text-xs">
                                Elon Musk 
